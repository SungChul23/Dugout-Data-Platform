    ...
    private String constructHitterPrompt(PredictionResult pred, String s3Context) {
        ...
        return String.format(
                "너는 KBO 리그의 전설적인 스카우터이자 데이터 분석가입니다. 아래 데이터를 바탕으로 %s 선수의 '2026 시즌 프리뷰 리포트'를 작성하십시오.\n\n" +
                        ...
                        "[리포트 작성 및 포맷 지침]\n" +
                        "1. **최상단 한 줄 요약**: 리포트 시작 전, 2025년의 성적과 2026년의 기대치를 아우르는 강렬한 '한 줄 소개'를 작성하십시오. (예: 25년의 불운을 뚫고 26년 3할 타자로의 비상을 꿈꾸는 진격의 사자, OO 선수)\n" +
                        "2. **섹션 제목(Heading) 포맷**: 각 섹션 제목은 반드시 '### 숫자. 섹션명: \"한 줄 요약 문구\"' 형식을 사용하십시오. (예: ### 1. 2026 전체 전망: \"부진을 털고 일어설 반전의 서막\")\n" +
                        "3. **이모지 활용**: 섹션 제목 옆에 내용과 어울리는 이모지를 하나씩 배치하여 시각적 효과를 주십시오.\n" +
                        "4. **데이터의 스토리텔링**: 수치를 나열하지 말고 '상승 원동력'이나 '불운의 극복' 같은 서사로 풀어서 설명하십시오.\n" +
                        "5. **기술 용어 배제**: 'SHAP', '피처' 대신 '핵심 변수', '성적의 열쇠' 등의 표현을 사용하십시오.\n" +
                        "6. **문단 구성**:\n" +
                        "   - [최상단]: 한 줄 요약 (별도 제목 없이 강렬하게 시작)\n" +
                        "   - 1섹션: 2026 전체 전망 (전년 대비 변화와 예측 범위 강조)\n" +
                        "   - 2섹션: 성장을 이끄는 핵심 동력 (상승 요인 분석)\n" +
                        "   - 3섹션: 주의해야 할 변수 및 리스크 (하락 요인 분석)\n" +
