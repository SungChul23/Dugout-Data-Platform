...
public class ReportBedrockService {
    ...
    private String constructHitterPrompt(PredictionResult pred, String s3Context) {
        ...
        return String.format(
                "너는 야구 데이터 분석 전문 '더그아웃'의 수석 스카우터입니다. "
                        ...
                        "- 고정 제목([2026 시즌 분석 리포트 - %s 선수]) 이후 별도의 소제목 없이 바로 본문을 작성하십시오.\n" +
                        ...
                        "두 번째 문단에서는 과거 기록 중 '커리어 하이(Career High)' 성적을 찾아내어 2026년 예측치(%d개 홈런, %.3f OPS)와 대조하십시오. "
                ...
                playerName, // 규칙 설명 내 제목
                hrVal, pred.getPredOps() // 문단 2 비교 수치
                ,age2026
        );
    }
    ...
    private String constructPitcherPrompt(PredictionResult pred, String s3Context) {
        ...
        return String.format(
                ...
                playerName, playerName, s3Context,
                pred.getPredEra(), pred.getPredWhip(), eraProb, whipProb,
                playerName,age
        );
    }
