    ...
    public String generateReason(String teamName, String year, String stats, String userPreference) {
        ...
        String prompt = String.format(
                "안녕하세요, 더그아웃 스카우터 입니다. 반갑습니다.\n\n" +
                        ...
                        "지금은 2026년이고, 너는 과거의 데이터와 서사를 분석하여 사용자에게 가장 적합한 팀을 추천하고 있어.\n\n" +
                        ...
                        "3. **데이터 기반 분석**: 기록(%3$s)과 사용자의 취향(%4$s)을 논리적으로 연결하십시오.\n" +
                        "   - 특히 사용자가 '불펜'이나 '든든한 마무리'를 선호한다면, 제공된 세이브와 홀드 수치를 직접 인용하여 분석하십시오.\n" + // <--- 이 부분 추가!
